package com.athanasios.protal2023.V1.db;

import com.athanasios.protal2023.V1.BlockChain.*;
...
public class Database {
    ...
    public static Database getInstance() {
        return Database.DatabaseHolder.database;
    }

    public void insertNewProduct(Block block){
        try {
